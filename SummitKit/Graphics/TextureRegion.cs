...
public class TextureRegion {
    ...
    public void Draw(SpriteBatch spriteBatch, Vector2 position, Color color, bool centered = false)
    {
        Draw(spriteBatch, position, color, 0.0f, centered ? new Vector2(Width, Height) * 0.5F : Vector2.Zero, Vector2.One, SpriteEffects.None, 0.0f);
    }
